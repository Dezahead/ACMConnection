package com.csangels.acmconnection.acmconnection.Chat;
...
import com.csangels.acmconnection.acmconnection.CalendarActivity;
import com.csangels.acmconnection.acmconnection.PicturesActivity;
import com.quickblox.chat.QBChatService;
import com.quickblox.chat.model.QBChatMessage;
import com.quickblox.chat.model.QBDialog;
import com.quickblox.core.QBEntityCallbackImpl;
import com.quickblox.core.request.QBRequestGetBuilder;
import com.csangels.acmconnection.acmconnection.R;
import com.csangels.acmconnection.acmconnection.core.ChatManager;
import com.csangels.acmconnection.acmconnection.core.GroupChatManagerImpl;
import com.csangels.acmconnection.acmconnection.core.PrivateChatManagerImpl;
import com.csangels.acmconnection.acmconnection.Chat.adapters.ChatAdapter;
...
public class ChatActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.chat) {
            ...
            Intent intent = new Intent(ChatActivity.this, PicturesActivity.class);
            startActivity(intent);
            finish();
            return true;
        }
        else if(id == R.id.action_add){
            Intent intent = new Intent(ChatActivity.this, NewDialogActivity.class);
            startActivity(intent);
            finish();
            return true;
        }
