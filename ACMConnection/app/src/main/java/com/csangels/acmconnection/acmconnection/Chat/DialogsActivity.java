...
import com.csangels.acmconnection.acmconnection.Chat.adapters.DialogsAdapter;
import com.csangels.acmconnection.acmconnection.PicturesActivity;
import com.csangels.acmconnection.acmconnection.R;
import com.csangels.acmconnection.acmconnection.SignInActivity;
...
public class DialogsActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            ...
            Intent intent = new Intent(DialogsActivity.this, CalendarActivity.class);
            startActivity(intent);
            finish();
            return true;
        }
        else if(id == R.id.pictures){
            Intent intent = new Intent(DialogsActivity.this, PicturesActivity.class);
            startActivity(intent);
            finish();
            return true;
        }
